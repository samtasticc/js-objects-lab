...
// const starterPokemon = pokemon.find(poke => poke.starter === true);
// game.party.push(starterPokemon);
// const firePokemon = pokemon.find(poke => poke.type === 'fire' && !poke.starter);
// const waterPokemon = pokemon.find(poke => poke.type === 'water' && !poke.starter);
// const highHPPokemon = pokemon.find(poke => poke.hp > 100);
...
const evolveStarter = (starter) => {
    let evolvedPokemon;
    switch (starter.number) {
        case 1: // Bulbasaur
        ...
        case 25: // Pikachu
            ...
            break;
        default:
            evolvedPokemon = starter;
    }
    return evolvedPokemon;
}
const starterIndex = game.party.findIndex(poke => poke.starter === true);
if (starterIndex !== -1) {
    game.party.splice(starterIndex, 1, evolveStarter(game.party[starterIndex]));
}
console.log(game);
...
*/
pokemon.filter(poke => poke.starter).forEach(poke => {
...
// };
// const chosenPokemon = pokemon.find(poke => poke.name === "Charmander"); // Choose any Pokemon
